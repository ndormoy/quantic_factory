...
// 		startIndex := int(math.Round(float64(len(spentValues)-1) * quantile))
// 		endIndex := int(math.Round(float64(len(spentValues)-1) * nextQuantile))
// 		// endIndex := int(math.Ceil(float64(len(spentValues)) * nextQuantile))
